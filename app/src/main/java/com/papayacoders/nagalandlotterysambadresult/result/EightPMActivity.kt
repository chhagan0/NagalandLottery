...
import com.papayacoders.nagalandlotterysambadresult.databinding.ActivityEightPmactivityBinding

class EightPMActivity : mainapp() {
    lateinit var binding: ActivityEightPmactivityBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this)
            .load(com.papayacoders.nagalandlotterysambadresult.config.Result.result3)
