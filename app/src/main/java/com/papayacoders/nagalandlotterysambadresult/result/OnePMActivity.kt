...
import com.papayacoders.nagalandlotterysambadresult.databinding.ActivityOnePmactivityBinding

class OnePMActivity : mainapp() {
    lateinit var binding: ActivityOnePmactivityBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOnePmactivityBinding.inflate(layoutInflater)
        ...
        Glide.with(this)
            .load(com.papayacoders.nagalandlotterysambadresult.config.Result.result1)
